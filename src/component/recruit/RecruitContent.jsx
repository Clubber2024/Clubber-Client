  ...
  const handleFavorite = async () => {
    ...
    try {
      if (!isAdmin && accessToken) {
        ...
        //즐겨찾기 추가
        if (!isFavorite) {
          const address = await customAxios.post(
        ...
        <div className={styles.total_div}>
          ...
          <div className={styles.date_div}>
            <p className={styles.content_date}>
              {new Date(contentData?.createdAt).toLocaleDateString()}
            </p>
            <p className={styles.content_date}>
              조회수 {contentData?.totalView}
            </p>
          </div>
          ...
          <div className={styles.content_div}>
            <div className={styles.everytime_div}>
              <img
                src="/recruit/everytime.png"
                alt="ET"
                className={styles.everyTime_img}
              />
              <a href={contentData?.everytimeUrl}>
                <p className={styles.everyTime_p}>
                  {contentData?.everytimeUrl}
                </p>
              </a>
            </div>
