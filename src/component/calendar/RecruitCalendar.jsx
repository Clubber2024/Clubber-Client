                ...
                <div className="calendar_header">
                    <div className="calendar_header_left">
                        ...
                        <div className="calendar_chevrons">
                            <ChevronLeftSquareIcon className="chevron_left" onClick={() => changeMonth(-1)} />
                            <ChevronRightSquareIcon className="chevron_right" onClick={() => changeMonth(1)} />
                        </div>
                    </div>
                    <div className="calendar_header_right">
                        <p className="day_event_start">{isMobile ? '모집 시작일' : '▶︎ 모집 시작일'}</p>
                        <p className="day_event_end">{isMobile ? '모집 마감일' : '◀︎ 모집 마감일'}</p>
                        <p className="day_event_always">{isMobile ? '상시 모집' : '◆ 상시 모집'}</p>
                    </div>
                </div>
                                            ...
                                            {date.semester != 'ALWAYS' &&
                                                ...
                                                month === getMonth(date.endAt) + 1 && (
                                                    <div key="date.clubId" className="day_event_end">
                                                        <a href={date.everytimeUrl} className="calendar_club_a">
                                                            <p className="calendar_club">◀︎ {date.clubName}</p>
                                                        </a>
                                                        <img
                                                            className="calendar_star"
                                                            src={
                                            ...
                                            {date.semester === 'ALWAYS' &&
                                                ...
                                                month === getMonth(date.startAt) + 1 && (
                                                    <div key="date.clubId" className="day_event_always">
                                                        <a href={date.everytimeUrl} className="calendar_club_a">
                                                            <p className="calendar_club">
                                                                {isMobile ? date.clubName : `◆ ${date.clubName}`}
                                                            </p>
                                                        </a>
                                                        <img
                                                            className="calendar_star"
