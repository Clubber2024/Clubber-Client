        ...
        <BrowserRouter>
          <div style={wrapper}>
            ...
            <Routes>
              ...
              />
              <Route
                path="/central/divisions"
                element={<BranchCentralPage />}
              />
              ...
              <Route
                path="/recruit/club/:clubId"
                element={<DetailRecruitList />}
              />
              ...
              <Route
                ...
                element={<AdminRecruitWrite />}
              />
              <Route
                path="/admin/recruit/:recruitId"
                element={<AdminRecruitContent />}
              />
              ...
              <Route
                path="/login/adminFindPassword"
                element={<FindAdminPassword />}
              />
              <Route
                path="/login/adminResetPassword"
